...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        from .helpers.utils import _triggertools, _triggerutils, _format, install_pip, reply_id
        ...
        mod._triggerutils = _triggerutils
        mod._triggertools = _triggertools
    ...
    if pattern is not None:
        if pattern.startswith(r"\#"):
            ...
            if len(Config.COMMAND_HAND_LER) == 2:
                triggerreg = "^" + Config.COMMAND_HAND_LER
                reg = Config.COMMAND_HAND_LER[1]
            elif len(Config.COMMAND_HAND_LER) == 1:
                triggerreg = "^\\" + Config.COMMAND_HAND_LER
                reg = Config.COMMAND_HAND_LER
            args["pattern"] = re.compile(triggerreg + pattern)
    ...
    if pattern is not None:
        if pattern.startswith(r"\#"):
            ...
            if len(Config.SUDO_COMMAND_HAND_LER) == 2:
                triggerreg = "^" + Config.SUDO_COMMAND_HAND_LER
...
def errors_handler(func):
    async def wrapper(errors):
        try:
            ...
            text = "**TriggeredUserbot Error report**\n\n"
            link = "[here](https://t.me/triggeredsupport)"
